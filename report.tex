...
\begin{acgroupdef}[list=acronyms]
	\acdef{DOE}{Design of Experiments}
...
\begin{flushleft}
	...
	\justify
	\normalfont
		Este documento tem como objetivo analisar o planejamento de um experimento: um modelo de helicóptero de papel. O propósito principal foi identificar quais são os fatores que mais influenciam em seu comportamento e como utilizá-los para melhorar o seu desempenho. Durante o processo, foi medido o seu tempo de queda em duas alturas diferentes, além disto, pedaços de fita foram colados em seu corpo e um clipe foi adicionado em sua parte inferior a fim de verificar a influência da variação destes parâmetros no resultado final. Para realizar o estudo estatístico dos dados foi utilizada a ferramenta R, uma linguagem de programação voltada à manipulação, 
...
% Conteúdo do relatório  
	...
	\include{sections/02estudo}
	\include{sections/03experimento}
